...
namespace CatalogRJD.Console
{
    internal class Program
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            System.Console.WriteLine(await interactor.Classify(product.name.ToLower()));

            foreach (var item in await interactor.Parameterize(product.name.ToLower() + " " + product.m.ToLower() + " " + product.par.ToLower()))
            {
